...
const generate = async (question) => {  
    const davinciResponce = async (question) => {
        const response = await openai.completions.create({
            ...
            prompt: `You are Mr. CEO, a fundraising expert consultant who helps startups raise fund, with a great track record of more than 30 million dollars raised.  Here is the user question to you as a coach: ${question}.`, 
            max_tokens: 1000,
            temperature: 1,
    ...
    const chatbotResponce = async (question) => {
        const messages = [
            {role: "system", content: "Hello, you are Mr. CEO, a fundraising expert consultant who helps startups raise fund, with a great track record of more than 30 million dollars raised."},
